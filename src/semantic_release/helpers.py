...
def parse_git_url(url: str) -> ParsedGitUrl:
    ...
    # Run the normalizers on the url (⚡ Bolt: avoiding re.compile() in loop for performance)
    for pattern, replacement in GIT_URL_NORMALIZER_PATTERNS:
