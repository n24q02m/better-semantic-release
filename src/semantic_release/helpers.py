...
# Performance optimization: Pre-compile regex patterns at the module level to avoid compiling on every parse_git_url call
GIT_URL_NORMALIZERS = [
...
def parse_git_url(url: str) -> ParsedGitUrl:
    ...
    for pattern, replacement in GIT_URL_NORMALIZERS:
