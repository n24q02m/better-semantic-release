...
def sort_numerically(
    ...
    # We use a standard for-loop with extend/append instead of reduce(acc + next_item)
    # as the reduce approach results in O(N^2) complexity due to list copying on every concatenation.
    result = []
