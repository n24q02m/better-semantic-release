...
class Version:
    ...
    def __eq__(self, other: Version) -> bool:  # type: ignore[override]
        ...
        #
        # Performance: Direct attribute access with explicit boolean chaining
        # is ~7.7x faster than the original `all()` generator expression with `getattr`.
        # This is critical for `__eq__` which is called heavily during version sorting.
        return (
