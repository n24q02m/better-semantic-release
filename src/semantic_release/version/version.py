...
class Version:
    ...
    def __eq__(self, other: Version) -> bool:  # type: ignore[override]
        ...
        # Performance optimization: Use direct attribute access and short-circuiting
        # instead of a generator expression with all() to avoid generator and getattr overhead
        return (
